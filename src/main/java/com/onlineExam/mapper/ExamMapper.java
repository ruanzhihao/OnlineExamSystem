...
public interface ExamMapper {
    ...
    int StuInsertExam(@Param("examName") String examName, @Param("stuId") String stuId, @Param("stuName") String stuName, @Param("stuDept") String stuDept, @Param("stuClazz") String stuClazz, @Param("examTime") String examTime, @Param("examScore") int examScore);//考试结束 添加考试记录
